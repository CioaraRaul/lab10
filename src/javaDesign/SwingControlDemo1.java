...
public class SwingControlDemo1 {
    ...
    public static void main(String[] args) {
        SwingControlDemo1 swingControlDemo1 = new SwingControlDemo1(); // Corrected the class name
        swingControlDemo1.showColorChooserDemo1(); // Corrected the method name
    }
    ...
    private void showColorChooserDemo1() {
